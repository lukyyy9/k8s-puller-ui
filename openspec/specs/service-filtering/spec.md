# Service Filtering Specification

## Requirements

### Requirement: Dependency Search Filters
The system SHALL provide inputs to filter services by "Dependency Name" and optionally "Dependency Version" on the Services page.

#### Scenario: Display filter inputs
- **WHEN** the user views the Services page
- **THEN** the system displays the "Dependency Name" and "Dependency Version" input fields alongside a "Search" submit button.
